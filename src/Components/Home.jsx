...
function Home() {
  ...
  return (
    <div>
      ...
      <div>
        <section id="home">
          <h2>NSTI-R   e Learning  </h2>
          <p>
            {" "}
            This is a massive open online course provider, and its
